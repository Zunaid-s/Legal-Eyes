        ...
        <div className="ls-auth-container">
          ...
          <div className="ls-auth-panel left">
            <div>
              ...
              <p>Join thousands of people who've stopped blindly signing legal documents.</p>
            </div>
          ...
          <div className="ls-auth-panel">
            ...
            {tab === 'login' ? (
              <div className="ls-auth-form">
                ...
                <button className="ls-social-btn" onClick={() => showToast('Google Sign-In requires OAuth setup.')}>
